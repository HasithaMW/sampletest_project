...
//                $(e).hasClass("active") ? $(e).removeClass("active") : $(e).addClass("active")
    ...
    handleMobileSidebar = function() {
        ...
        $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind("touchstart", function(a) {
            ...
            } else parseInt(e) >= 0 || n >= o ? $(a).animate({
                marginTop: "0px"
            }) : (l = e, $(a).animate({
                marginTop: l + "px"
            }))
    ...
    App = function() {
        ...
        return {
            init: function() {
                this.initSidebar(), this.initTopMenu(), this.initPageLoad(), this.initComponent(), this.initLocalStorage(), this.initThemePanel()
            },
            ...
            initComponent: function() {
                handleIEFullHeightContent(), handleSlimScroll(), handleUnlimitedTabsRender(), handlePanelAction(), handelTooltipPopoverActivation(), handleScrollToTopButton(), handleAfterPageLoadAddClass(), handleDraggablePanel()
            },
